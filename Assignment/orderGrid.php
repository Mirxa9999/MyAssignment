                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>Admin Uplaod PDF</th>
                                        <th>Admin Uplaod PNG</th>
                                        ...
                                        <tr>
                                            <td class="d-flex justify-content-center pt-4">
                                                ...
                                                if ($fet['admin_upload_File_pdf']) {
                                                    ...
                                                    <a href="./assignmentPDFFile/<?php echo  $value ?>"  target="_blank" class="mx-2"><i class="fa-solid fa-file-pdf  text-success" style="font-size: 20px;"></i></a>
                                                    <?php
                                                    }
                                            ...
                                            if ($fet['admin_upload_File_png']) {
                                                ...
                                                foreach ($allPNG as $keyPNG => $valuePNG) {
                                                    ...
                                                    if ($keyPNG >= 2) {
                                                        ?>
                                                        <img src="./assignmentPNGFile/<?php echo $valuePNG ?>" alt="not Work" width="80px" height="80px">
                                                        <?php
                                                    }
                                                }
                                            }
